...
const InfoCard: React.FC<InfoCardProps> = ({
  ...
  return (
    <div
      ...
      } bg-yellow-100 rounded-lg overflow-hidden`}
    >
  ...
  const sections: Section[] = [
    {
      title: "About Us",
      content:
        "At our core, we aim to simplify personal finance for individuals who struggle with budgeting, saving, and investing. We recognize that many users feel overwhelmed by the complexities of day-to-day financial management and lack access to personalized insights and advice that can guide them toward better financial decisions. Our platform is designed to bridge these gaps and provide real-time, AI-powered assistance to make finance more manageable, personalized, and effective.",
      imageSrc: "/ak1.jpg",
      imageAlt: "About Us",
    },
    {
    ...
    },
    {
      ...
      content:
        "We strive to empower users by providing tools and insights that allow them to manage their finances independently and confidently. Our platform promotes financial well-being through a user-centered, AI-driven experience that prioritizes simplicity, data privacy, and global accessibility. Our vision extends beyond current offerings, with plans to enhance AI capabilities for predictive financial forecasting, expand globally with real-time exchange rate services, and collaborate with financial institutions to offer premium features and more personalized services. We're committed to helping users grow their financial knowledge and wealth sustainably while navigating the ever-changing financial landscape.",
      imageSrc: "/ak4.jpg",
